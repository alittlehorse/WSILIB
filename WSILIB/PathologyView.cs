...
namespace WSILIB
{
    ...
    class PathologyView
    {
        ...
        internal PathologyView(int start_x, int start_y, int PreAreaWidth, int PreAreaHeight, int CurrentLevel)
        {
            ...
            SingleFrameHeight = DataManager.GetSpecialImageInformationBySOPINstancUID<int>(ImageInformation.R, tmp_sopinstanceuid);
            SingleFrameWidth = DataManager.GetSpecialImageInformationBySOPINstancUID<int>(ImageInformation.C, tmp_sopinstanceuid);
